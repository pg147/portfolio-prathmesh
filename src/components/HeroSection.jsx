...
export default function HeroSection() {
  return (
    <div className='relative h-full flex justify-between w-full'>
      ...
      <div className='absolute top-0 xl:right-0 2xl:right-48 z-[-5] h-full w-full max-w-sm bg-gradient-to-b from-transparent from-0% via-primary/20 via-20% to-primary to-100%'>
