...
export default function RecentWork() {
    return (
        <div className="px-5 md:px-0 w-full xl:max-w-[1050px] 2xl:max-w-[1400px] mx-auto mt-20 flex flex-col md:flex-row justify-between gap-y-7 pt-10 md:pt-16 pb-12 md:pb-24 bg-gradient-to-l from-transparent via-primary/5 to-transparent">
            ...
            <div className="w-fit flex flex-col gap-y-8 md:flex-row items-center xl:gap-x-6 2xl:gap-x-14">
