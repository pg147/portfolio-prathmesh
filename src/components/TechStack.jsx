...
export default function TechStack() {
    return (
        <div className="px-4 md:px-14 lg:px-0 w-full mt-12 md:mt-20 md:mx-auto flex flex-col md:grid md:grid-cols-2 lg:grid-cols-3 gap-x-20 gap-y-14 items-start justify-between xl:max-w-[1050px] 2xl:max-w-[1400px]">
