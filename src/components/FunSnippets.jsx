export default function FunSnippets() {
    return (
        <div className="w-fit flex flex-col gap-y-3 font-code text-sm md:text-xl">
            ...
            <div className="w-[90%] md:size-fit px-3 md:px-6 py-3 md:py-4 bg-tile border-[1.5px] border-stroke rounded-2xl">
            ...
            <div className="z-[20] absolute top-44 right-3 md:static size-fit p-3 md:px-6 md:py-4 bg-tile border-[1.5px] border-stroke rounded-2xl">
